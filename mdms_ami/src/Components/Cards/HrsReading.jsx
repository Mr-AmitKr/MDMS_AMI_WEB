...
import Last24hoursChart from '../Charts.jsx/Last24hoursChart';

const HrsReading = () => {
  const cradDesign = () => {
    return " flex bg-gray-900 h-60 w-60 rounded-2xl px-4 py-4 bg-gradient-to-r from-gray-800 to-gray-500 shadow-[0_0_8px_rgba(100,110,110,0.6)] h-70 w-69 ";
  };  
  const headingDesign = () =>{
    ...
    <div className="min-w-[280px]">
      <div className={cradDesign()}>
        <div>
         ...
         Reading Last 24Hours
          </h4>
          <h1 className="text-[30px] font-bold text-gray-300 ">440 kwh</h1>
          <h2 className="text-[16px] font-bold text-green-700">ONL: 0</h2>
          <h2 className="text-[16px] font-bold text-red-700">OFL: 0</h2>
        </div>
        <div className="relative w-[80px] h-[80px] shrink-0 mt-12">
          <svg
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-[#22c55e] font-semibold text-sm leading-none">2.1%</span>
          </div>
        </div>
      </div>
