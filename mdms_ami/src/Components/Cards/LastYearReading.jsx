  ...
  return (
      ...
      <div className={cradDesign()}>
        <div>
          ...
          <h1 className="text-[30px] font-bold text-gray-300 ">14,912 kwh</h1>
        ...
        <div className="relative w-[80px] h-[80px] shrink-0 mt-12">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-[#22c55e] font-semibold text-sm leading-none">2%</span>
          </div>
        </div>
      </div>
      <LastYearCharts/>
...
export default LastYearReading
